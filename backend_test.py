#!/usr/bin/env python3
"""
GYMBLE2 API Test Script

This script tests the gym management system with proper role-based access:
- QR code generation requires owner/staff authentication
- Attendance marking requires member authentication
- 403 errors for unauthorized actions are expected and correct
"""
...
class Gymble2APITester:
    ...
    def test_member_attendance_marking(self):
        ...
        attendance_data = {
            ...
            "device_info": "Test Device - API Test"
        }
    ...
    def run_comprehensive_test(self):
        ...
        print("🚀 GYMBLE2 API - Comprehensive Test Suite")
        print("=" * 70)
        print("🔧 Testing:")
        ...
        print("   • Dashboard stats and live updates")
        ...
        if self.tests_passed == self.tests_run:
            ...
            print("   • Dashboard stats and live updates working")
            print("   • Calendar integration functional")
        else:
...
if __name__ == "__main__":
    print("🔧 GYMBLE2 API Tester - Testing Role-Based Access Control")
    print("This script tests the complete gym management system workflow\n")
    
    tester = Gymble2APITester()
